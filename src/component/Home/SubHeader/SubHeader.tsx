...
const SubHeader = ({ selectedRegion, setSelectedRegion, darkMode, setSearchValue, searchValue }: SubHeaderProps) => {
      ...
      <div className={classes.container}>
        <TextField
          ...
          InputProps={{
            ...
            endAdornment: (
              <CloseIcon className={classes.closeIcon} onClick={() => setSearchValue('')} />
            )
          }}
        />
